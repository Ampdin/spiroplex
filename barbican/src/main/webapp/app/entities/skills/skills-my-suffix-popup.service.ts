...
@Injectable()
export class SkillsMySuffixPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.skillsModalRef(component, new SkillsMySuffix());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    skillsModalRef(component: Component, skills: SkillsMySuffix): NgbModalRef {
