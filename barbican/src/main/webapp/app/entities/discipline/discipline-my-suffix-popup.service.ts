...
@Injectable()
export class DisciplineMySuffixPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.disciplineModalRef(component, new DisciplineMySuffix());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    disciplineModalRef(component: Component, discipline: DisciplineMySuffix): NgbModalRef {
