...
describe('Resource e2e test', () => {
    ...
    it('should load Resources', () => {
        navBarPage.goToEntity('resource-my-suffix');
        resourceComponentsPage = new ResourceComponentsPage();
        expect(resourceComponentsPage.getTitle()).toMatch(/barbicanApp.resource.home.title/);
    ...
    it('should load create Resource dialog', () => {
        ...
        expect(resourceDialogPage.getModalTitle()).toMatch(/barbicanApp.resource.home.createOrEditLabel/);
    ...
    it('should create and save Resources', () => {
        ...
        resourceDialogPage.setResourceAvatorInput(absolutePath);
...
export class ResourceComponentsPage {
    ...
    title = element.all(by.css('jhi-resource-my-suffix div h2 span')).first();
...
export class ResourceDialogPage {
    ...
    resourceAvatorInput = element(by.css('input#file_resourceAvator'));
    ...
    setResourceAvatorInput = function (resourceAvator) {
        this.resourceAvatorInput.sendKeys(resourceAvator);
    }

    getResourceAvatorInput = function () {
        return this.resourceAvatorInput.getAttribute('value');
    }
