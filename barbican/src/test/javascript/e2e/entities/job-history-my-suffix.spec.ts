...
describe('JobHistory e2e test', () => {
    ...
    it('should load JobHistories', () => {
        ...
        expect(jobHistoryComponentsPage.getTitle()).toMatch(/barbicanApp.jobHistory.home.title/);
    ...
    it('should load create JobHistory dialog', () => {
        ...
        expect(jobHistoryDialogPage.getModalTitle()).toMatch(/barbicanApp.jobHistory.home.createOrEditLabel/);
