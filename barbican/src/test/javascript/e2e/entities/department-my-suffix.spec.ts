...
describe('Department e2e test', () => {
    ...
    it('should load Departments', () => {
        ...
        expect(departmentComponentsPage.getTitle()).toMatch(/barbicanApp.department.home.title/);
    ...
    it('should load create Department dialog', () => {
        ...
        expect(departmentDialogPage.getModalTitle()).toMatch(/barbicanApp.department.home.createOrEditLabel/);
