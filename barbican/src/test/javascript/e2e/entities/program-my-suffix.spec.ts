...
describe('Program e2e test', () => {
    ...
    it('should load Programs', () => {
        navBarPage.goToEntity('program-my-suffix');
        programComponentsPage = new ProgramComponentsPage();
        expect(programComponentsPage.getTitle()).toMatch(/barbicanApp.program.home.title/);
    ...
    it('should load create Program dialog', () => {
        ...
        expect(programDialogPage.getModalTitle()).toMatch(/barbicanApp.program.home.createOrEditLabel/);
    ...
    it('should create and save Programs', () => {
        ...
        programDialogPage.setProgramAvatorInput(absolutePath);
...
export class ProgramComponentsPage {
    ...
    title = element.all(by.css('jhi-program-my-suffix div h2 span')).first();
...
export class ProgramDialogPage {
    ...
    programAvatorInput = element(by.css('input#file_programAvator'));
    ...
    setProgramAvatorInput = function (programAvator) {
        this.programAvatorInput.sendKeys(programAvator);
    }

    getProgramAvatorInput = function () {
        return this.programAvatorInput.getAttribute('value');
    }
