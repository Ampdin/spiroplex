...
describe('Lesson e2e test', () => {
    ...
    it('should load Lessons', () => {
        navBarPage.goToEntity('lesson-my-suffix');
        lessonComponentsPage = new LessonComponentsPage();
        expect(lessonComponentsPage.getTitle()).toMatch(/barbicanApp.lesson.home.title/);
    ...
    it('should load create Lesson dialog', () => {
        ...
        expect(lessonDialogPage.getModalTitle()).toMatch(/barbicanApp.lesson.home.createOrEditLabel/);
    ...
    it('should create and save Lessons', () => {
        ...
        lessonDialogPage.setLessonAvatorInput(absolutePath);
...
export class LessonComponentsPage {
    ...
    title = element.all(by.css('jhi-lesson-my-suffix div h2 span')).first();
...
export class LessonDialogPage {
    ...
    lessonAvatorInput = element(by.css('input#file_lessonAvator'));
    ...
    setLessonAvatorInput = function (lessonAvator) {
        this.lessonAvatorInput.sendKeys(lessonAvator);
    }

    getLessonAvatorInput = function () {
        return this.lessonAvatorInput.getAttribute('value');
    }
