...
describe('Discipline e2e test', () => {
    ...
    it('should load Disciplines', () => {
        navBarPage.goToEntity('discipline-my-suffix');
        disciplineComponentsPage = new DisciplineComponentsPage();
        expect(disciplineComponentsPage.getTitle()).toMatch(/barbicanApp.discipline.home.title/);
    ...
    it('should load create Discipline dialog', () => {
        ...
        expect(disciplineDialogPage.getModalTitle()).toMatch(/barbicanApp.discipline.home.createOrEditLabel/);
    ...
    it('should create and save Disciplines', () => {
        ...
        disciplineDialogPage.setDisciplineAvatorInput(absolutePath);
...
export class DisciplineComponentsPage {
    ...
    title = element.all(by.css('jhi-discipline-my-suffix div h2 span')).first();
...
export class DisciplineDialogPage {
    ...
    disciplineAvatorInput = element(by.css('input#file_disciplineAvator'));
    ...
    setDisciplineAvatorInput = function (disciplineAvator) {
        this.disciplineAvatorInput.sendKeys(disciplineAvator);
    }

    getDisciplineAvatorInput = function () {
        return this.disciplineAvatorInput.getAttribute('value');
    }
