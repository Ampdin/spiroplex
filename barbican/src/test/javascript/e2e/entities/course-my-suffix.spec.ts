...
describe('Course e2e test', () => {
    ...
    it('should load Courses', () => {
        ...
        expect(courseComponentsPage.getTitle()).toMatch(/barbicanApp.course.home.title/);
    ...
    it('should load create Course dialog', () => {
        ...
        expect(courseDialogPage.getModalTitle()).toMatch(/barbicanApp.course.home.createOrEditLabel/);
    ...
    it('should create and save Courses', () => {
        ...
        courseDialogPage.setCourseAvatorInput(absolutePath);
...
export class CourseDialogPage {
    ...
    courseAvatorInput = element(by.css('input#file_courseAvator'));
    ...
    setCourseAvatorInput = function (courseAvator) {
        this.courseAvatorInput.sendKeys(courseAvator);
    }

    getCourseAvatorInput = function () {
        return this.courseAvatorInput.getAttribute('value');
    }
