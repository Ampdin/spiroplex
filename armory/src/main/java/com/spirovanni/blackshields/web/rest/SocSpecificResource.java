...
public class SocSpecificResource {
    ...
    @Timed
    public ResponseEntity<List<SocSpecificDTO>> getAllSocSpecifics(@ApiParam Pageable pageable) {
    ...
    @Timed
    public ResponseEntity<List<SocSpecificDTO>> searchSocSpecifics(@RequestParam String query, @ApiParam Pageable pageable) {
